...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/USERNAME/REPONAME@main/css/avadaextra.css?v=1">
```
...
3. Either bump the `?v=` query string in the `<link>` tag, OR hit the purge URL:
   `https://purge.jsdelivr.net/gh/USERNAME/REPONAME@main/css/avadaextra.css`
